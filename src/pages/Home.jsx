  ...
  return (<>
    <div id='/' className='bg-[#F1F0E8] flex flex-wrap mt-20 min-h-screen' >
      <div className='md:w-2/5 w-full sm:m-0 mt-10  flex justify-center items-center '>
        <img className=' border-[10px] border-zinc-50 rounded-[50%] sm:w-96 sm:h-96 w-60 h-60' src={aditya} alt="image" />
      </div>
      <div className='md:w-3/5 sm:w-full sm:pt-[10%] pt-[5%] sm:pr-24 p-2'>
             ...
             <h1 className='font-bold text-center sm:text-5xl text-3xl pt-2'>Aditya Narayan Maurya</h1>
            ...
            <a href="" className='transform hover:scale-110 transition duration-200 sm:text-2xl text-sm m-3 mt-5 border border-[#B3C8CF] py-2 px-4 my-3 rounded-[50px] hover:text-slate-100 hover:bg-[#89A8B2]'>Download CV <i className="fa-solid fa-arrow-down-long"></i></a>
            <a href="https://www.linkedin.com/in/aditya-narayan-maurya-23b0352a0/" className='transform hover:scale-110 transition duration-200 sm:text-2xl text-sm m-1 mt-5 py-1 px-1 my-3 rounded-[50px] '><i className="fa-brands fa-linkedin"></i></a>
            <a href="https://github.com/Aditya-Narayan-Maurya" className='transform hover:scale-110 transition duration-200 sm:text-2xl text-sm m-1 mt-5 py-1 px-1 my-3 rounded-[50px] '><i className="fa-brands fa-github"></i></a>
            </div>
