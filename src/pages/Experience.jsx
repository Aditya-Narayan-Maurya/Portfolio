...
<VerticalTimeline lineColor='#89A8B2'>
  ...
  >
    ...
    <h4 className="vertical-timeline-element-subtitle text-center font-medium ">Shri Dev Narayan Singh Inter Collage Pakarpur, Sultanpur(2019)</h4>
    <p className='text-center  font-thin '>
    I successfully completed my high school in 2019 under the UP Board, securing an
     excellent score of 88.17%. During this time, I received several awards and certificates
  ...
  >
    ...
    <h4 className="vertical-timeline-element-subtitle text-center font-medium">Shri Dev Narayan Singh Inter Collage Pakarpur, Sultanpur(2021)</h4>
    <p className='text-center font-light'>
    I successfully completed my 12th in 2021 under the UP Board, achieving a commendable score of 83.2%. My efforts
