...
const Contact = () => {
  ...
  return (
    <div>
      ...
      <form action="" className='border md:w-1/2 md:ml-[25%] w-11/12 ml-[4%] p-6 rounded-3xl'>
         ...
         <button onSubmit={handleSubmit} className='border bg-black border-[#B3C8CF] p-3 px-4 my-3 rounded-[50px] hover:text-slate-100 relative overflow-hidden group '>
