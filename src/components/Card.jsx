...
const Card = () => {
  return (
    <div className='w-[380px] h-[454px] m-4 mx-10 p-2 border border-[#B3C8CF] rounded-lg'>
      ...
      <button className='transform hover:scale-110 transition duration-200 text-2xl m-3 mt-5 bg-[#89A8B2] text-slate-100 border border-[#B3C8CF] py-2 px-4 my-3 rounded-[50px] hover:text-black hover:bg-[#F5EFFF]'><a href="">Explore</a></button>
