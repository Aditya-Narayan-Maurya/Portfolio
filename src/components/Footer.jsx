...
const Footer = () => {
  return (
    ...
    <div className="container mx-auto">
      {/* Name and Title */}
      <h2 className="text-2xl font-semibold">Aditya Narayan Maurya</h2>
      ...
      <div className="flex justify-center mt-4 space-x-4">
        <a href="https://www.linkedin.com/in/aditya-narayan-maurya-23b0352a0/" target="_blank" rel="noopener noreferrer">
          <i className="fa-brands fa-linkedin text-2xl hover:text-[#89A8B2]"></i>
        </a>
        <a href="https://github.com/Aditya-Narayan-Maurya" target="_blank" rel="noopener noreferrer">
          <i className="fa-brands fa-github text-2xl hover:text-[#89A8B2]"></i>
        </a>
      </div>
  
      {/* Copyright */}
      <p className="mt-4 text-gray-500">© 2024 Aditya Narayan Maurya. All rights reserved.</p>
